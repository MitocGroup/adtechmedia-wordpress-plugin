...
class Adtechmedia_Request
{
    ...
    private static function getPledgedType($pledgedType){
        $types=['transactions'=>'count',
            'pledged currency'=>'amount'];
        return $types[$pledgedType];
    }

    private static function getOffsetType($offsetType){
        $types=['words'=>'words',
            'paragraphs'=>'elements'];
        return $types[$offsetType];
    }
    /**
     * @param $id
     * @param $container
        ...
        $data = [
            ...
            "ConfigDefaults" => [
                "content" => [
                    ...
                    'lock' => $contentLock,
                    "offsetType" => self::getOffsetType($offsetType),
                ...
                "payment" => [
                    ...
                    "currency" => $currency,
                    "pledgedType" => self::getPledgedType($pledgedType),
                ],
                /*"templates"=>[
