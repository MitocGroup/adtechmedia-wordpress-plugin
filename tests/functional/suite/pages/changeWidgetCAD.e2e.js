...
const widgetApplied = 'Widget can be applied on posts for CAD';

fixture `Widget can be applied on posts and modified from WP configuration page for CAD`
...
test(widgetApplied, async t => {
  ...
  await t
    ...
    .typeText(elements.price,'2.39', { replace: true })
    .click(elements.save);
    ...
    .expect(widget.priceCheck.innerText).eql('$2.39')
